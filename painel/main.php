...
<div class="area-menu">
	...
	<div class="area-menu">
		<div class="loggout">
			...
			<a id="temaDark" name="theme" <?php if(@$_GET['url'] == ''){ ?> <?php } ?>><i data-feather="moon"></i></a>
			<a id="temaLight" name="theme" <?php if(@$_GET['url'] == ''){ ?> <?php } ?>><i data-feather="sun"></i></a>
